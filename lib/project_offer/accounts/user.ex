defmodule ProjectOffer.Accounts.User do
  ...
  schema "users" do
    ...
    field :locked_account_at, :utc_datetime
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, ProjectOffer.Repo)
  ...
  @doc """
  Locks the account by setting `locked_account_at`.
  """
  def lock_changeset(user) do
    now = DateTime.utc_now() |> DateTime.truncate(:second)
    change(user, locked_account_at: now)
  end
  ...
  """
  def valid_password?(%ProjectOffer.Accounts.User{hashed_password: hashed_password}, password)
